#
# Be sure to run `pod lib lint CustomPod_Example_Axon.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CustomPod_Example_Axon.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'CustomPod_Example_Axon/Classes/**/*'
  
  # s.resource_bundles = {
  #   'CustomPod_Example_Axon' => ['CustomPod_Example_Axon/Assets/*.png']
  # }
